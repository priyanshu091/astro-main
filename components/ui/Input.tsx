      ...
      <div className="relative">
        <input
          ...
          className={
            ...
            (error
              ...
              : "border-[rgba(184,146,40,0.12)] focus:border-gold-400 focus:shadow-[0_0_0_3px_rgba(138,107,18,0.12)] ") +
            className
          }
          aria-invalid={!!error}
          {...props}
        ...
        <label
          ...
          className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 font-sans text-[15px] text-text-muted transition-all duration-200
            peer-focus:top-2.5 peer-focus:translate-y-0 peer-focus:text-[11px] peer-focus:font-medium peer-focus:text-gold-600
